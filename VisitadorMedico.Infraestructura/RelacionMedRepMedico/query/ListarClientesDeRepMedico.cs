...
{
    public class ListarClientesDeRepMedico
    {
        ...
        public class Manejador : IRequestHandler<Ejecutar, object>
        {
            ...
            {
                var stroreprocedure = "visitadormedico.SP_ListarClientesAsignadosxcanalventa_RM";
                var parametros = new Dictionary<string, object>();

                if (e.filtro == null || e.filtro is null) e.filtro = "";
