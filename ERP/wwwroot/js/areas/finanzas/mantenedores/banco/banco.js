...
$('#form-registro').submit(function (e) {
    e.preventDefault();
    var url = ORIGEN + "/Finanzas/FBanco/RegistrarEditar";
...
function agregarFila(data) {
    ...
    tbllista.row.add([
        ...
        `<div class="btn-group btn-group-sm" >            
            ...
            <button class="btn btn-sm bg-danger waves-effect text-white" onclick="mensajeeliminar(`+ data.idbanco + `)"><i class="fas fa-trash-alt"></i></button>                                                                 
        </div>`
    ]).draw(false);
}
...
function eliminar(id) {
    var url = ORIGEN + "/Finanzas/FBanco/Eliminar/" + id;
