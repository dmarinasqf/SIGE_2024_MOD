...
$(document).ready(function () {
    tbllista = $('#tbllista').DataTable({
        ...
        dom: 'Bfrtip',
        responsive: true,        
        buttons: BOTONESDATATABLE('LISTA DE PAISES ', 'V', false),
...
$('#form-registro').submit(function (e) {
    e.preventDefault();
    var url = ORIGEN + "/Maestros/Pais/RegistrarEditar";
...
function agregarFila(data) {
    ...
    tbllista.row.add([
        ...
        `<div class="btn-group btn-group-sm" >            
            ...
            <button class="btn btn-sm bg-danger waves-effect text-white" onclick="mensajeeliminar(`+ data.idpais + `)"><i class="fas fa-trash-alt"></i></button>                                                                 
        </div>`
    ]).draw(false);
}
...
function eliminar(id) {
    var url = ORIGEN + "/Maestros/Pais/Eliminar/" + id;
