...
$('#form-registro').submit(function (e) {
    e.preventDefault();
    var url = ORIGEN + "/Almacen/ALaboratorio/RegistrarEditar";
    ...
    tbllista.row.add([
        ...
        `
                   <div class="btn-group btn-group-sm">
                                                <button class="btn btn-sm btn-outline-warning waves-effect btn-pasar"><i class="fa fa-edit"></i></button>
                                                <button class="btn btn-sm btn-outline-danger waves-effect" onclick="mensajeeliminar(`+ data.idlaboratorio +`)"><i class="fa fa-trash-alt"></i></button>
                                                <a class="btn btn-sm btn-outline-secondary waves-effect  font-10" data-toggle="tooltip" data-placement="top" title="Agregar representante"href="/Almacen/ALaboratorio/IndexRepresentante/`+data.idlaboratorio+`" target="_blank"><i class="fas fa-user"></i></a>
                    </div>  `
    ]).draw(false);
}
...
function eliminar(id) {
    var url = ORIGEN + "/Almacen/ALaboratorio/Eliminar/" + id;
