    ...
    app = new Vue({
        ...
        methods: {
            recuperarDatos: function () {
                ...
                this.cabeceraadicional = cabeceraadicional;
                ...
                for (var i = 0; i < this.detalle.length; i++) {
                    var UM = "";
                    if (this.detalle[i].CODIGO.includes("IS"))
                        UM = "KGM";
                    else
                        UM = "UND";
                    ...
                    fila += '<td style="text-align:center" >' +  UM + '</td>';
...
function GenerarQR(texto) {
    ...
    //setTimeout(function () {
    //    var qr = document.getElementById("codigo-qr");
    //    qr.getElementsByTagName('img')[0].style.display = '';
    //}, 000);
    //var qrx = document.getElementById("qrcode");
    //qrx.setAttribute = ('src',texto);
    //console.log(qr);
    //console.log(img);
    //img.style.display = '';
}