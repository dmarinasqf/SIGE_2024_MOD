...
{
    public class ReporteHoraOpTerminado
    {
        ...
        public class Manejador : IRequestHandler<Ejecutar, object>
        {
            ...
            {
                var stroreprocedure = "SP_REPORTEHORA_OP_TERMINADO";
                ...
                {
                    var tabla = await procedimiento.HandlerDatatableAsync(stroreprocedure, parametros, "horaOPTerminado");
